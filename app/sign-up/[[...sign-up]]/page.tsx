      ...
      <div className="w-full max-w-7xl bg-white dark:bg-neutral-950 rounded-3xl shadow-2xl overflow-hidden flex">
        ...
        <div className="w-full max-w-md">
          {!verifying ? (
            <>
              <div className="mb-10">
                <h1 className="text-4xl font-bold text-neutral-900 dark:text-white mb-3">Create account</h1>
                <p className="text-neutral-600 dark:text-neutral-400">Start your collaboration journey today</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-center text-sm text-neutral-600 dark:text-neutral-400">
                  ...
                  <Link href="/sign-in" className="text-neutral-900 dark:text-white font-semibold">
                    Sign in
                  </Link>
                </p>
              </div>
            ...
            <>
              <div className="mb-10">
                <h1 className="text-4xl font-bold text-neutral-900 dark:text-white mb-3">Verify your email</h1>
                <p className="text-neutral-600 dark:text-neutral-400">We sent a code to {email}</p>
              </div>
              ...
              <form onSubmit={handleVerify} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded-lg text-neutral-900 dark:text-white text-center text-2xl tracking-widest placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-neutral-900 dark:focus:ring-white focus:border-transparent"
                    placeholder="000000"
                    maxLength={6}
                  />
                </div>
